...
const servicesData = [
  {
    ...
    description:
      'I build complete, scalable software products by combining modern frontend technologies, robust backend systems, databases, and AI capabilities. From architecture and development to deployment, I focus on creating production-ready applications.',
    capabilities: [
  ...
  },
  {
    ...
    description:
      'I create modern, responsive, and interactive interfaces focused on performance, usability, and strong visual experiences across desktop, tablet, and mobile devices.',
    capabilities: [
      'React.js',
      'Next.js',
      'TypeScript',
  ...
  },
  {
    ...
    description:
      'I design secure and scalable backend systems that power modern applications with reliable APIs, efficient databases, authentication, real-time communication, and clean system architecture.',
    capabilities: [
      'FastAPI',
      'Node.js & Express.js',
  ...
  },
  {
    ...
    description:
      'I integrate AI into real-world products to build intelligent features, automate repetitive workflows, analyze data, and create applications that can understand and respond to users naturally.',
    capabilities: [
      'LLM integration',
      'OpenAI APIs',
      'LangChain',
  ...
  },
  {
    ...
    description:
      'I develop cross-platform mobile applications with responsive interfaces, smooth interactions, reliable backend integration, and performance-focused architecture.',
    capabilities: [
      'Flutter',
      'React Native',
  ...
  },
  {
    ...
    description:
      'I build reliable development and deployment workflows using modern engineering tools, containerization, automation, monitoring, and cloud infrastructure to make applications easier to deploy and maintain.',
    capabilities: [
      'Git & GitHub',
      'Docker',
      'CI/CD pipelines',
