...
const aboutWords = [
  { text: "Hey," }, { text: "I'm" },
  { text: "Mayveno.", className: "font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400" },
  { text: "A" }, { text: "Software" }, { text: "Developer" }, { text: "and" }, { text: "Full-Stack" }, { text: "Engineer" },
  { text: "passionate" }, { text: "about" }, { text: "building" }, { text: "modern" }, { text: "scalable" }, { text: "and" }, { text: "impactful" }, { text: "digital" }, { text: "experiences." },

  { text: "I" }, { text: "love" }, { text: "transforming" }, { text: "ideas" }, { text: "into" }, { text: "real-world" }, { text: "products" }, 
  { text: "with" }, { text: "clean" }, { text: "architecture," }, { text: "efficient" }, { text: "code," }, { text: "and" }, { text: "exceptional" }, { text: "user" }, { text: "experiences." },

  { text: "My" }, { text: "tech" }, { text: "stack" }, { text: "includes" },
  { text: "React,", className: "text-white font-medium" },
  { text: "Next.js,", className: "text-white font-medium" },
  ...
  { text: "I" }, { text: "enjoy" }, { text: "creating" }, { text: "innovative" }, { text: "solutions" }, { text: "like" },
  { text: "AI" }, { text: "analytics" }, { text: "platforms," },
  { text: "real-time" }, { text: "applications," },
  { text: "and" }, { text: "developer-focused" }, { text: "tools." },

  { text: "Always" }, { text: "learning." }, 
  { text: "Always" }, { text: "building." },
