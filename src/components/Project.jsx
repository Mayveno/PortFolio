...
const projects = [
    {
        ...
        description:
            'An AI-powered analytics dashboard with real-time insights, predictive analysis, and automated reporting, helping users turn complex data into actionable intelligence and make faster, data-driven decisions.',
        image:
    ...
    },
    {
        ...
        description:
            'A full-stack e-commerce platform with inventory management, real-time stock updates, secure Stripe payments, and a scalable architecture designed to provide a smooth and reliable online shopping experience.',
        image:
    ...
    },
    {
        ...
        description:
            'A real-time messaging platform featuring encrypted communication, video calling, file sharing, and live presence detection, built to provide fast, secure, and seamless communication between users.',
        image:
            'https://images.unsplash.com/photo-1611926653458-09294b3142bf?q=80&w=2000&auto=format&fit=crop'
    },
    {
        name: 'InfraWatch',
        title: (
        ...
        description:
            'A DevOps monitoring platform for tracking infrastructure metrics, system performance, real-time alerts, and visualizing application health to help developers identify and respond to issues quickly.',
        image:
    ...
    },
    {
        ...
        description:
            'An AI-powered content verification platform that analyzes text, images, and videos to identify potentially misleading, manipulated, or unreliable content and helps users evaluate the credibility of digital information.',
        image:
    ...
    },
    {
        ...
        description:
            'An AI-powered GitHub code analysis platform that analyzes repositories and projects to understand code quality, architecture, development patterns, and potential issues, helping developers gain deeper insights into their codebases.',
        image:
